...
export default function NewArtworkPage() {
  ...
  return (
    <div className="mx-auto max-w-4xl">
      <h1 className="mb-6 text-2xl font-bold text-zinc-900">Nova Obra</h1>
        ...
        <div className="rounded-md border border-zinc-200 bg-white p-6">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-md border border-zinc-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-zinc-900"
                placeholder="Óleo sobre tela, etc."
              />
            </div>
            <div>
          ...
          <div className="mt-4">
            ...
            <input
              ...
              className="w-full rounded-md border border-zinc-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-zinc-900"
              placeholder="abstract, surrealism, digital"
            />
          </div>
        </div>
              ...
              {artists.map((artist) => (
                ...
                >
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="text-sm text-zinc-700">{artist.name}</span>
                </label>
              ))}
            </div>
          ) : (
