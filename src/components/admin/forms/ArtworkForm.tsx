    ...
    <form onSubmit={handleSubmit} className="space-y-8">
      ...
      {formData.type && (
        <div className="space-y-4">
          ...
          <div className="border border-zinc-200 rounded-lg p-6 text-center text-zinc-500">
      ...
      <div className="flex justify-end gap-4 pt-6 border-t border-zinc-200">
        <button
          type="button"
          onClick={() => router.back()}
          className="px-6 py-2 border border-zinc-300 rounded-md text-zinc-700 hover:bg-zinc-50"
        >
          Cancelar
        </button>
        <button
          ...
          className="flex items-center gap-2 px-6 py-2 bg-zinc-900 text-white rounded-md hover:bg-zinc-800 disabled:opacity-50"
        >
          {isLoading ? (
            <>
